...
from src.models import MirrorConfig, NordVPNServer, PingResult, VPNRecommendation
...
class TestPingResult:
    ...
    def test_avg_latency_all_set(self) -> None:
        m = MirrorConfig(domain="stake.com", url="https://stake.com")
        r = PingResult(
            mirror=m, tcp_latency_ms=10.0, https_latency_ms=20.0, api_latency_ms=30.0
        )
    ...
    def test_best_latency(self) -> None:
        m = MirrorConfig(domain="stake.com", url="https://stake.com")
        r = PingResult(
            mirror=m, tcp_latency_ms=10.0, https_latency_ms=20.0, api_latency_ms=5.0
        )
